    ...
    <div id="background-div" class="page-holder bg-cover">
      ...
      <div class="container py-5">
        <header class="text-left text-white py-5">
          <h3 class="mb-4 rounded"><a href="#start-shopping" class="bg-white px-2 py-2 rounded" id="heading">Commencer a commander</a></h3>
          <p id="content" class="lead mb-0 bg-dark p-1 rounded">Plateforme développer à partir de vuejs et nodejs pour le  commerce électronique complète avec backend et frontend pour Web et Android.
          </p>
        </header>
      </div>
    </div>
