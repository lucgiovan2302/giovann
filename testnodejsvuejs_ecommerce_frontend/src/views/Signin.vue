    ...
    <div class="row">
      <div class="col-12 justify-content-center d-flex flex-row pt-5">
        <div id="signin-div" class="flex-item border">
          <h2 class="pt-4 pl-4">Se connecter</h2>
          <form @submit="signin" class="pt-4 pl-4 pr-4">
            ...
            <small class="form-text text-muted"
              >En continuant, vous acceptez les conditions d'utilisation et la politique de confidentialité de et l'avis de confidentialité.</small
            >
